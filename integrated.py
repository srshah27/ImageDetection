...
## -----------------------------paths ----------------------------------------
imgPath = "./IMG_00016.JPG"
saveFolder = "snehil_try"
tempFolder = "snehil_try\out"
...
def calculate():
    ...
    cv.imwrite(f"{saveFolder}\cropped_img.jpg", imgFile)
    detectMinGruve()
    writeOutput(imgPath, full_width, max_height, min_height)
